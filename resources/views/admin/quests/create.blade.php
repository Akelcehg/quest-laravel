...
@section('content')
    <div class="container">
        ...
        {{ Form::open(['url'=>'/admin/quests', 'method'=>'POST', 'files'=>'true']) }}
        ...
        <div class="row">
            <div class="form-group col-md-4  {{$errors->has("people_min") ? 'has-error' : ''}}">
                ...
                {{ Form::number('people_min', Input::old('people_min'), array('class' => 'form-control')) }}
            ...
            <div class="form-group col-md-4  {{$errors->has("people_max") ? 'has-error' : ''}}">
                ...
                {{ Form::number('people_max', Input::old('people_max'), array('class' => 'form-control')) }}
            ...
            <div class="form-group col-md-4  {{$errors->has("default_price") ? 'has-error' : ''}}">
                ...
                {{ Form::number('default_price', Input::old('default_price'), array('class' => 'form-control')) }}
        ...
        {{ Form::submit('Создать квест', array('class' => 'btn btn-primary')) }}
