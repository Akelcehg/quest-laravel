...
@push('styles')
<link href="/css/admin/calendar.css" rel="stylesheet">
@endpush
    ...
    <div class="container">
        <div class="row">
                ...
                <div id="collapseTwo" class="collapse in">
                    <div class="list-group">
                        <div class="list-group-item">
                            <a href="#course_1" data-toggle="collapse" class="text-success"><strong>MGMT
                                    310A</strong></a>
            ...
            <div id="calendar" class="col-sm-8 col-md-9 animated animated-sm bounceInUp">
                <h2>Calendar
                    <small>plan it</small>
                    {{--<i class="fa fa-plus fa-fw pull-right small btn btn-block"></i>--}}
                </h2>
                            ...
                            <table class="fc-header" style="width:100%">
                                ...
                                <tr>
                                    <td class="fc-header-left">
                                        {{--<div class="btn-group">
                                            <button type="button"
                                                    class="fc-button-prev fc-corner-left btn btn-default btn-sm"><i
 ...
 {{--                                   <div style="position:absolute;z-index:8;top:0;left:0">
                                    ...
                                    <table class="fc-border-separate" style="width:100%" cellspacing="0">
                                        ...
                                        <tr class="fc-first fc-last">
                                            ...
                                            <th class="fc-day-header fc-tue fc-widget-header" style="width: 158px;">
                                                Tue
                                            </th>
                                            <th class="fc-day-header fc-wed fc-widget-header" style="width: 158px;">
                                                Wed
                                            </th>
                                            <th class="fc-day-header fc-thu fc-widget-header" style="width: 158px;">
                                                Thu
                                            </th>
                                            <th class="fc-day-header fc-fri fc-widget-header" style="width: 158px;">
                                                Fri
                                            </th>
                                            <th class="fc-day-header fc-sat fc-widget-header fc-last"
                                                style="width: 158px;">Sat
                                            </th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr class="fc-week fc-first">
                                            <td class="fc-day fc-sun fc-widget-content fc-other-month fc-first"
                                            ...
                                            <td class="fc-day fc-mon fc-widget-content fc-other-month"
                                            ...
                                            <td class="fc-day fc-tue fc-widget-content fc-other-month"
                                                data-date="2013-12-31">
                                                <div>
                                                    <div class="fc-day-number">31</div>
                                                    <div class="fc-day-content">
                                                        <div style="position: relative; height: 25px;">66</div>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr class="fc-week">
                                            ...
                                            <td class="fc-day fc-wed fc-widget-content fc-today fc-state-highlight"
                                        ...
                                        <tr class="fc-week">
                                            ...
                                            <td class="fc-day fc-sat fc-widget-content fc-other-month fc-last"
                                        ...
                                        <tr class="fc-week fc-last">
                                            ...
                                            <td class="fc-day fc-wed fc-widget-content fc-other-month"
                                            ...
                                            <td class="fc-day fc-thu fc-widget-content fc-other-month"
                                            ...
                                            <td class="fc-day fc-fri fc-widget-content fc-other-month"
